...
$con = open_conexao();
selectDb();
$rs = mysql_query("select * from os;"); //rs=record set (conjunto de registros)
close_conexao($con);
?>
      ...
      <fieldset> 
        ...
        <div class="row col-md-7">
          <table  class="table table-striped">
            <tr>
             <th widht="300" align="right">Cliente</th>
             <th widht="80" align="right">Aparelho</th>
             <th widht="80" align="right">Status</th>
           ...
           <tr>
            ...
            <td><?php echo $row['aparelho'] ?></td>
            <td><?php echo $row['status'] ?></td>
            

            <td>
              <button type="button" class="btn btn-warning"
              onclick="javascript:location.href='../alterar/altOs.php?id=' 
              + <?php echo $row['id'] ?> ">

...
<body class="container">   
  ...
  <form class="form-horizontal id=cadCli" name="cadCli" method="post" action="../validar/valAlterCli.php">
    <fieldset>
      ...
      <legend>Alterar Dados de Cliente</legend>
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" class="form-control input-md" id="txtNome" name="txtNome" value="<?php echo $nome?>">
        </div>
      </div>

      <div class="form-group">
        <label class="col-md-4 control-label" for="idNome">Endereço </label>
        <div class="col-md-5">
          <input type="text" class="form-control input-md" id="txtEnd" name="txtEnd" value="<?php echo $end?>" >
        </div>
      </div>


      <div class="form-group">
        <label class="col-md-4 control-label" for="idNome">Cidade </label>
        <div class="col-md-5">
          <input type="text" class="form-control input-md" id="txtCid" name="txtCid" value="<?php echo $cid?>">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" class="form-control input-md" id="txtEst" name="txtEst" value="<?php echo $est?>">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" class="form-control input-md" id="txtTel" name="txtTel" value="<?php echo $tel?>">
        </div> 
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" class="form-control input-md" id="txtCpf" name="txtCpf" value="<?php echo $cpf?>">
        </div>  
      </div>


      <div class="form-group">
        <label class="col-md-4 control-label" for="idNome">Nascimento </label>
        <div class="col-md-5">
          <input type="text" class="form-control input-md" id="txtNas" name="txtNas" value="<?php echo $nas?>">
        </div>
      </div>
